...
const translations = {
  en: {
    ...
    why_2_t: "Modern UI", why_2_d: "Contemporary, clean interfaces that feel current, not templated.",
  ...
  bn: {
    ...
    btn_explore_services: "সার্ভিস দেখুন",
    ...
    why_2_t: "আধুনিক UI", why_2_d: "পরিচ্ছন্ন ইন্টারফেস যা টেমপ্লেটেড নয়, বরং একদম আধুনিক মনে হয়।",
